...
Un taux mesure le [risque de survenue]{.cb} d'un évènement [au cours d'une période]{.cb}. 
...
Un ratio est un rapport des effectifs de [deux modalités d'une variable binaire]{.cb}.
...
Un indice est le rapport de deux effectifs [de nature différente]{.cb}.
...
La @fig-cible-d représente une situation où la mesure n'apporte aucune information. Sa répétition ne donne jamais la même valeur, et rarement la bonne valeur : la mesure n'est [ni fiable ni valide]{.cb}.
...
Est-elle valide pour autant ? Souvenez-vous qu'en raison du défaut de calibrage de l'appareil, chaque valeur mesurée surestime la température réelle de +1°C : aussi fiable soit-elle, la mesure [ne correspond pas à la réalité]{.cb}.
