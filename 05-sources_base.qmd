...
- Le [certificat de décès]{.cb1} (@sec-deces)
- La liste des [maladies à déclaration obligatoire]{.cb1} (@sec-mdo)

### Certificat de décès {#sec-deces}
...
Le certificat de décès doit être produit [par le médecin ayant constaté le décès]{.cb1} (cette habilité pourrait cependant être [étendue](https://www.ameli.fr/infirmier/exercice-liberal/prescription-prise-charge/prise-charge-situation-type-soin/certificats-deces-par-infirmier) à l'avenir).

Il se compose de deux volets :

::: {layout-ncol=2}

| [ADMINISTRATIF]{.cb1}<br>déclaration à l'état civil |
|:---:|
| nom et prénom |
| domicile |
...
| [MÉDICAL]{.cb1}<br>suivi épidémiologique |
|:---:|
...
En 2024, il existe 38 [Maladies à Déclaratoire Obligatoire  (MDO)](https://www.santepubliquefrance.fr/maladies-a-declaration-obligatoire/liste-des-maladies-a-declaration-obligatoire). Elles ont toutes en commun d'être des [maladies infectieuses]{.cb1}, à deux exceptions (le mésothéliome et le saturnisme chez l'enfant mineur).
...
| [SIGNALEMENT]{.cb1} |
|:---:|
| **nominatif**<br>pour engager des mesures préventives |
| maladies nécessitant une **intervention urgente**<br>*(toutes sauf VIH, hépatite B aiguë, tétanos, mésothéliome et Covid-19)*. |

| [NOTIFICATION]{.cb1} |
|:---:|
| **anonyme**<br>pour le suivi épidémiologique |
...
La situation des trois premières est actualisée de façon [hebdomadaire]{.cb1} (chaque mercredi) et représentée graphiquement à un niveau national (par interpolation des données obtenues localement).
...
Le [Système National des Données de Santé (SNDS)](https://www.assurance-maladie.ameli.fr/etudes-et-donnees/en-savoir-plus-snds/presentation-systeme-national-donnees-sante-snds) a été crée en 2016. Il s'agit d'une base de données elle-même construite à partir de plusieurs sources de données :
...
- **Aide à la recherche ou l'évaluation présentant un caractère publique**
...
- **Aide à la mise en oeuvre de politiques de santé**
...
- **Meilleure connaissance des dépenses de santé**
