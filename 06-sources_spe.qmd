...
- Enquête [exhaustive]{.cb1} (@sec-part-exhaust)
...
::: callout-tip
## Les pathologies sont diverses et doivent être facilement repérables
...
::: callout-tip
## L'étude portant sur l'obésité présentée plus haut (@fig-pop-2) est un exemple d'enquête transversale
:::
...
- **Résultat** : la présence de troubles cognitifs était la principale cause de dépendance du sujet âgé en France
:::

::: callout-tip
## La plus importante cohorte en population française : [CONSTANCES](https://www.constances.fr/) (depuis 2012)
...
::: callout-important
# Une enquête transversale mesure une prévalence, tandis qu'une enquête longitudinale mesure une incidence
:::
