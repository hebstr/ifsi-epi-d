...
Solution ? Présenter la mesure accompagnée d'un [intervalle]{.cb1} qui rendra compte de la [variabilité autour de cette mesure]{.cb1}.
...
Ce niveau de confiance doit être défini : jusqu'à quel point peut-on avoir confiance dans la précision de l'estimation de la vraie valeur ? Par tradition, ce niveau est fixé à [95%]{.cb1}.
