...
Le texte [souligné]() peut correspondre soit à un lien vers une autre partie du cours (chapitre, section, figure, ...), soit à un lien vers une ressource externe au cours.
...
Autrement dit, [tout ce qui peut être demander de connaitre pour l'examen est présent dans le cours]{.cb1}.

Le cours est centré avant tout sur la compréhension. Il n'est pas demandé de connaitre des listes, des chiffres ou des formules mathématiques.
...
Toute annotation peut être [définitivement supprimée]{.cb1} après publication.
