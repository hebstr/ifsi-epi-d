...
Si davantage de personnes sont exposées à des facteurs favorisent le développement de d'une maladie (e.g., tabagisme pour le cancer du poumon, alimentation riche en graisses saturées pour les maladies cardiovasculaires), l'incidence [augmente]{.cb}.
...
Une meilleure déclaration permet de capturer un nombre plus important de cas existants dans la population : l'incidence [augmente]{.cb}. 
Cela peut donner l'impression d'une augmentation du nombre de nouveaux cas, alors qu'il s'agit en réalité d'une [meilleure identification des cas existants]{.cb}.
...
Un changement de définition de la maladie pourrait aussi bien entraîner une augmentation ou une diminution de l'incidence et de la prévalence, selon qu'elle est plus large ou plus restrictive.
:::
